...
- 0.1.0: v2 스키마와 snapshot을 배포하고 legacy 기본을 유지합니다.
- 최초 7일: 기준점 워밍업만 수행합니다.
- 다음 7일: v2를 shadow/명시 옵션으로 노출하고 legacy 기본을 유지합니다.
- 승인 게이트 통과 후 0.2.0에서 v2 Overview를 기본으로 전환합니다.
