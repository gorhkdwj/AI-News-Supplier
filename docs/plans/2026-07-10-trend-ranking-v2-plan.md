...
> 부기(2026-07-12, D-008): V2-0~V2-5 구현 완료. 워밍업 달력 기준일은 상시 수집이 시작된 2026-07-12이며, 워밍업 ~07-19 → shadow 비교 ~07-26 → 게이트 평가 순으로 진행합니다. 0.2.0은 v2 기본 전환과 D-007 개선 묶음을 함께 담아 게이트 통과 후 publish합니다. 상세 게이트와 버전 규범은 기준 계약 13절을 따릅니다.
